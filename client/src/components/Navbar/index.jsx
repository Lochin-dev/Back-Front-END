    ...
    <div>
      <nav className="navbar navbar-expand-lg navbar-light bg-light">
        <div className="container">
          <a className="navbar-brand me-2" href="home">
            <img
              className="nav_img"
          ...
          <div className="collapse navbar-collapse" id="navbarButtonsExample">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              <li className="nav-item">
                <a className="nav-link fs-2 fw-bold" href="home">
                  HOUSE
                </a>
              </li>
            </ul>
            <div className="w-50 d-flex align-items-center justify-content-between">
              <button onClick={() => loginLink()} className="ui_btn w-25">
                Login
              </button>
              <div className="dark_ligt">
